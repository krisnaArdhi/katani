...
<html lang="en">
  ...
  <!-- container section end -->
    ...
    <!-- jquery ui -->
    <script src="<?php echo base_url(); ?>bahan/js/jquery-ui-1.9.2.custom.min.js"></script>

    <!--custom checkbox & radio-->
    <script type="text/javascript" src="<?php echo base_url(); ?>bahan/js/ga.js"></script>
    <!--custom switch-->
    <script src="<?php echo base_url(); ?>bahan/js/bootstrap-switch.js"></script>
    <!--custom tagsinput-->
    <script src="<?php echo base_url(); ?>bahan/js/jquery.tagsinput.js"></script>
    
    <!-- colorpicker -->
   
    <!-- bootstrap-wysiwyg -->
    <script src="<?php echo base_url(); ?>bahan/js/jquery.hotkeys.js"></script>
    <script src="<?php echo base_url(); ?>bahan/js/bootstrap-wysiwyg.js"></script>
    <script src="<?php echo base_url(); ?>bahan/js/bootstrap-wysiwyg-custom.js"></script>
    <!-- ck editor -->
    <script type="text/javascript" src="assets/ckeditor/ckeditor.js"></script>
    <!-- custom form component script for this page-->
    <script src="<?php echo base_url(); ?>bahan/js/form-component.js"></script>
