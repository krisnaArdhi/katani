...
?>     
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> RENCANA ANGGARAN KELOMPOK TANI</h3>
                    <ol class="breadcrumb">
                      ...
                      <section class="panel">
                          ...
                          <form class="form-horizontal " method="post" action="<?php echo base_url();?>distributor/simpan">
                                   ...
                                   <div class="form-group">
                                      <label class="col-sm-2 control-label">NO REGIS</label>
                                      <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">PETANI</label>
                                      <div class="col-sm-10">
