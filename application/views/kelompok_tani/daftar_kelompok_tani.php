...
?>  
      ...
      <section id="main-content">
          <section class="wrapper">            
              ...
              <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-laptop"></i> DAFTAR KELOMPOK TANI</h3>
                    <ol class="breadcrumb">
                ...
                <div class="col-lg-9 col-md-12">    
                      <section class="panel">
                          ...
                          <form class="form-horizontal " method="post" action="<?php echo base_url();?>distributor/simpan">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">ANGGOTA 1</label>
                                      <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="file" name="alamat_toko" class="form-control">
                                    </div>
                                  </div>
                                
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">ANGGOTA 2</label>
                                      <div class="col-sm-10">
                                          <input type="text" name="nama_toko" class="form-control">
                                      </div>
                                  </div>  
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="password" name="alamat_toko" class="form-control">
                                    </div>
                                  </div>
