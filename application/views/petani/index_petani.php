          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="">Alat</a></li>                          
                          <li><a class="" href="">Bibit</a></li>
						  <li><a class="" href="">Pupuk</a></li>
						  <li><a class="" href="">Obat-obatan</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                      ...
                      <ul class="sub">
                          <li><a class="" href="">Desa</a></li>
						  <li><a class="" href="">Non Desa</a></li>
                      </ul>
                  </li>
...
?>
                              ...
                              <tbody>
                              <tr>
                                  <td><?php print $isi->nama_barang?></td>
                                  <td><?php print $isi->jenis_barang?></td>
                                  <td><?php print $isi->nama_distributor?> </td>
                                  <td><?php print $isi->harga?></td>
                                  <td><?php print $isi->stok?></td>
                              </tr>
 ...
 ?> 
    ...
    ?>
                              ...
                              <tbody>
                              <tr>
                                  <td><?php print $isi->id_pengepul?></td>
                                  <td><?php print $isi->jenis_pertanian?> </td>
                                  <td><?php print $isi->harga?></td>
                                  <td><?php print $isi->stok?></td>
                              </tr>
                              </tbody>
