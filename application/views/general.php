...
<html lang="en">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="mail_notificatoin_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="./<?php echo base_url(); ?>bahan/img/avatar-mini.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="./<?php echo base_url(); ?>bahan/img/avatar-mini2.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="./<?php echo base_url(); ?>bahan/img/avatar-mini3.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="./<?php echo base_url(); ?>bahan/img/avatar-mini4.jpg"></span>
                                    <span class="subject">
  ...
  <!-- container section end -->
    ...
    <script src="<?php echo base_url(); ?>bahan/js/gritter.js" type="text/javascript"></script>
