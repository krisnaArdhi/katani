          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?php echo base_url(); ?>kelompok_tani/daftar">Daftar Kelompok</a></li>
                          <li><a class="" href="<?php echo base_url(); ?>upt_pertanian/daftar_anggota_tani">Daftar Anggota</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="<?php echo base_url(); ?>distributor/data_distributor">data distributor</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
