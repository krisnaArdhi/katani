                      ...
                      <section class="panel">
                          ...
                          <form class="form-horizontal " method="post" action="<?php echo base_url();?>distributor/simpan">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" name="id_distributor" class="form-control">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">ID JENIS BARANG</label>
                                      <div class="col-sm-10">
                                          <input type="text" name="id_jenis_barang" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
